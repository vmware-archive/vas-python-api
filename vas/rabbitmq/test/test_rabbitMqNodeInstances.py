...
class TestRabbitMqNodeInstances(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__instances = RabbitMqNodeInstances(self.__client,
            'https://localhost:8443/rabbitmq/v1/nodes/0/instances/')
    ...
    def test__create_item(self):
        self.assertIsInstance(
            self.__instances._create_item(self.__client, 'https://localhost:8443/rabbitmq/v1/nodes/0/instances/3/'),
            RabbitMqNodeInstance)
