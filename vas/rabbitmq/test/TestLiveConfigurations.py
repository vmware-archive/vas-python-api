...
from vas.rabbitmq.LiveConfigurations import LiveConfigurations, LiveConfiguration
...
class TestLiveConfigurations(VasTestCase):
    def test_list(self):
        self._assert_collection(LiveConfigurations(self._client,
            'https://localhost:8443/rabbitmq/v1/groups/0/instances/1/configurations/live/'), 1)
        ...
        self._assert_item(LiveConfiguration(self._client,
            ...
            ('node_configurations', [
                NodeLiveConfiguration(self._client,
                    'https://localhost:8443/rabbitmq/v1/nodes/0/instances/4/configurations/live/7/'),
                NodeLiveConfiguration(self._client,
                    'https://localhost:8443/rabbitmq/v1/nodes/0/instances/3/configurations/live/6/')])
        ])
