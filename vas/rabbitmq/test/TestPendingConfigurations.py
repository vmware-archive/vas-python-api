...
from vas.rabbitmq.PendingConfigurations import PendingConfigurations, PendingConfiguration
from vas.test.VasTestCase import VasTestCase

class TestPendingConfigurations(VasTestCase):
    def test_list(self):
        self._assert_collection(PendingConfigurations(self._client,
            'https://localhost:8443/rabbitmq/v1/groups/0/instances/1/configurations/pending/'), 1)

    def test_create(self):
        content = 'configuration-content'
        location = 'https://localhost:8443/rabbitmq/v1/groups/0/instances/1/configurations/pending/'
        self._return_location('https://localhost:8443/rabbitmq/v1/groups/0/instances/1/configurations/pending/2/')
    ...
    def test_set_content(self):
        ...
        self._assert_post('https://localhost:8443/rabbitmq/v1/groups/0/instances/1/configurations/pending/2/content/',
            'new-content')
