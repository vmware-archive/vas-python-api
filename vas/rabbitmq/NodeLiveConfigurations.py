...
class NodeLiveConfiguration(NodeConfiguration):
    ...
    :ivar `vas.rabbitmq.LiveConfigurations.LiveConfiguration`   group_configuration:    The node configuration's group
                                                                                        configuration
    :ivar `vas.rabbitmq.NodeInstances.NodeInstance`             instance:               The instance the owns the
                                                                                        configuration
