...
class Installation(vas.shared.Installations.Installation):
    ...
    :ivar `vas.rabbitmq.Groups.Group`                           group:              The group that contains the
                                                                                    installation
    :ivar `vas.rabbitmq.InstallationImages.InstallationImage`   installation_image: The installation image that was used
