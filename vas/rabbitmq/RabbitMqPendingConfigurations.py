...
class RabbitMqPendingConfigurations(PendingConfigurations):
    """An collection of RabbitMQ pending configurations
    ...
    def _create_item(self, client, location):
        return RabbitMqPendingConfiguration(client, location)
