...
class RabbitMqLiveConfiguration(LiveConfiguration):
    """A RabbitMQ live configuration
    ...
    def __init__(self, client, location):
        super(RabbitMqLiveConfiguration, self).__init__(client, location, self.__REL_GROUP_INSTANCE)
