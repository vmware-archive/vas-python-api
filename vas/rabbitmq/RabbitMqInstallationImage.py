...
class RabbitMqInstallationImage(InstallationImage):
    """A RabbitMQ installation image

    :ivar list installations: The :class:`vas.rabbitmq.RabbitMqInstallation` s that use the installation image
