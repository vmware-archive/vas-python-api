...
class RabbitMqPendingConfiguration(PendingConfiguration):
    """A RabbitMQ pending configuration

    :ivar `vas.rabbitmq.RabbitMqGroupInstance` instance: The configuration's parent group instance
    ...
    def __init__(self, client, location):
        super(RabbitMqPendingConfiguration, self).__init__(client, location, self.__REL_GROUP_INSTANCE)
