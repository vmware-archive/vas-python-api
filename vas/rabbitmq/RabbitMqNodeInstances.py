...
class RabbitMqNodeInstances(CollectionType):
    """A collection of RabbitMQ node instances
    ...
    def __init__(self, client, location):
        super(RabbitMqNodeInstances, self).__init__(client, location, self.__COLLECTION_KEY)
