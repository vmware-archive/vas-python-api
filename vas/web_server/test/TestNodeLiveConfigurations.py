...
from vas.web_server.NodeLiveConfigurations import NodeLiveConfigurations, NodeLiveConfiguration
from vas.test.VasTestCase import VasTestCase

class TestNodeLiveConfigurations(VasTestCase):
    def test_list(self):
        self._assert_collection(NodeLiveConfigurations(self._client,
            'https://localhost:8443/web-server/v1/nodes/2/instances/3/configurations/live/'))

    def test_detail(self):
        self._assert_item(NodeLiveConfiguration(self._client,
            'https://localhost:8443/web-server/v1/nodes/0/instances/3/configurations/live/5/'), [
