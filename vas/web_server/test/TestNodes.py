...
from vas.web_server.Nodes import Nodes, Node
from vas.test.VasTestCase import VasTestCase

class TestNodes(VasTestCase):
    def test_list(self):
        self._assert_collection(Nodes(self._client, 'https://localhost:8443/web-server/v1/nodes/'))

    def test_detail(self):
        self._assert_item(Node(self._client, 'https://localhost:8443/web-server/v1/nodes/0/'), [
            ('agent_home', '/opt/vmware/vfabric-administration-agent'),
            ('architecture', 'x64'),
            ('groups', [Group(self._client, 'https://localhost:8443/web-server/v1/groups/1/'),
                        Group(self._client, 'https://localhost:8443/web-server/v1/groups/2/')]),
    ...
    def test_update(self):
        location = 'https://localhost:8443/web-server/v1/nodes/0/'
