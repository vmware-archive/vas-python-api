...
class GemFireAgentLiveConfiguration(LiveConfiguration):
    """A GemFire agent live configuration
    ...
    def __init__(self, client, location):
        super(GemFireAgentLiveConfiguration, self).__init__(client, location, self.__REL_GROUP_INSTANCE)
