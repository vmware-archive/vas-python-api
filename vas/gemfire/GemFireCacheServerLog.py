...
class GemFireCacheServerLog(Log):
    """A GemFire cache server log

    :ivar `datetime.datetime` last_modified: The time the log file was last modified
    :ivar str name: The name of the log
    :ivar `vas.gemfire.GemFireCacheServerNodeInstance` instance: The log's parent node instance
    ...
    def __init__(self, client, location):
        super(GemFireCacheServerLog, self).__init__(client, location, self.__REL_NODE_INSTANCE)
