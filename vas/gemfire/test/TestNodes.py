...
from vas.gemfire.Nodes import Nodes, Node
from vas.test.VasTestCase import VasTestCase

class TestNodes(VasTestCase):
    def test_list(self):
        self._assert_collection(Nodes(self._client, 'https://localhost:8443/gemfire/v1/nodes/'))

    def test_detail(self):
        self._assert_item(Node(self._client, 'https://localhost:8443/gemfire/v1/nodes/0/'), [
            ...
            ('architecture', 'x64'),
            ('cache_server_instances', lambda actual: self.assertIsInstance(actual, CacheServerNodeInstances)),
            ('groups', [Group(self._client, 'https://localhost:8443/gemfire/v1/groups/2/'),
                        Group(self._client, 'https://localhost:8443/gemfire/v1/groups/1/')]),
    ...
    def test_update(self):
        location = 'https://localhost:8443/gemfire/v1/nodes/0/'
