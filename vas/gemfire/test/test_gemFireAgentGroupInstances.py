...
class TestGemFireAgentGroupInstances(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__instances = GemFireAgentGroupInstances(self.__client,
            'https://localhost:8443/gemfire/v1/groups/2/agent-instances/')

    def test_delete(self):
        self.__instances.delete(
            GemFireAgentGroupInstance(self.__client, 'https://localhost:8443/gemfire/v1/groups/2/agent-instances/4/'))
        self.__client.delegate.delete.assert_called_once_with(
            'https://localhost:8443/gemfire/v1/groups/2/agent-instances/4/')

    def test_create(self):
        self.__client.delegate.post.return_value = 'https://localhost:8443/gemfire/v1/groups/2/agent-instances/4/'
        ...
        self.assertIsInstance(instance, GemFireAgentGroupInstance)
        self.__client.delegate.post.assert_called_once_with('https://localhost:8443/gemfire/v1/groups/0/agent-instances/',
    ...
    def test__create_item(self):
        self.assertIsInstance(
            self.__instances._create_item(self.__client, 'https://localhost:8443/gemfire/v1/groups/2/agent-instances/4/'),
            GemFireAgentGroupInstance)
