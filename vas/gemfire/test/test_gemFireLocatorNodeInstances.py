...
class TestGemFireLocatorNodeInstances(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__instances = GemFireLocatorNodeInstances(self.__client,
            'https://localhost:8443/gemfire/v1/nodes/0/locator-instances/')
    ...
    def test__create_item(self):
        self.assertIsInstance(
            self.__instances._create_item(self.__client, 'https://localhost:8443/gemfire/v1/nodes/0/locator-instances/3/'),
            GemFireLocatorNodeInstance)
