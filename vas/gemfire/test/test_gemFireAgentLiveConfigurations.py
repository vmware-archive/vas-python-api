...
class TestGemFireAgentLiveConfigurations(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__live_configurations = GemFireAgentLiveConfigurations(self.__client,
            'https://localhost:8443/gemfire/v1/groups/0/agent-instances/1/configurations/live/')
