...
from vas.gemfire.AgentPendingConfigurations import AgentPendingConfigurations, AgentPendingConfiguration
from vas.test.VasTestCase import VasTestCase

class TestAgentPendingConfigurations(VasTestCase):
    def test_list(self):
        self._assert_collection(AgentPendingConfigurations(self._client,
            'https://localhost:8443/gemfire/v1/groups/0/agent-instances/1/configurations/pending/'), 1)

    def test_create(self):
        location = 'https://localhost:8443/gemfire/v1/groups/0/agent-instances/1/configurations/pending/'
    ...
    def test_set_content(self):
        ...
        AgentPendingConfiguration(self._client,
            'https://localhost:8443/gemfire/v1/groups/0/agent-instances/1/configurations/pending/2/').content = 'new-content'
        self._assert_post(
            'https://localhost:8443/gemfire/v1/groups/0/agent-instances/1/configurations/pending/2/content/',
            'new-content')
