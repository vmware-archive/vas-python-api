...
class TestGemFireAgentLogs(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__logs = GemFireAgentLogs(self.__client,
            'https://localhost:8443/gemfire/v1/nodes/0/agent-instances/3/logs/')

    def test_delete(self):
        self.__logs.delete(
            GemFireAgentLog(self.__client, 'https://localhost:8443/gemfire/v1/nodes/0/agent-instances/3/logs/4/'))
