...
class TestGemFireLocatorGroupInstances(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__instances = GemFireLocatorGroupInstances(self.__client,
            'https://localhost:8443/gemfire/v1/groups/2/locator-instances/')
    ...
    def test_create(self):
        self.__client.delegate.post.return_value = 'https://localhost:8443/gemfire/v1/groups/2/locator-instances/4/'
        ...
        self.assertIsInstance(instance, GemFireLocatorGroupInstance)
        self.__client.delegate.post.assert_called_once_with(
            'https://localhost:8443/gemfire/v1/groups/0/locator-instances/',
            {'name': 'example', 'installation': 'https://localhost:8443/gemfire/v1/groups/1/installations/2/',
             'address': 'test-address', 'peer': True, 'port': 12345, 'server': False}, 'locator-group-instance')
    ...
    def test__create_item(self):
        self.assertIsInstance(
            self.__instances._create_item(self.__client,
                'https://localhost:8443/gemfire/v1/groups/2/locator-instances/4/'),
            GemFireLocatorGroupInstance)
