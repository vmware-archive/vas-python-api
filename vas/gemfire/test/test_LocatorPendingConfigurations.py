...
from vas.gemfire.LocatorPendingConfigurations import LocatorPendingConfigurations, LocatorPendingConfiguration
...
class TestLocatorPendingConfigurations(VasTestCase):
    def test_list(self):
        self._assert_collection(LocatorPendingConfigurations(self._client,
            'https://localhost:8443/gemfire/v1/groups/0/locator-instances/1/configurations/pending/'), 1)

    def test_create(self):
        location = 'https://localhost:8443/gemfire/v1/groups/0/locator-instances/1/configurations/pending/'
    ...
    def test_set_content(self):
        ...
        LocatorPendingConfiguration(self._client,
            'https://localhost:8443/gemfire/v1/groups/0/locator-instances/1/configurations/pending/2/').content = 'new-content'
        self._assert_post(
