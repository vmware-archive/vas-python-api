...
class TestGemFireLocatorLogs(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__logs = GemFireLocatorLogs(self.__client,
            'https://localhost:8443/gemfire/v1/nodes/0/locator-instances/3/logs/')

    def test_delete(self):
        self.__logs.delete(
            GemFireLocatorLog(self.__client, 'https://localhost:8443/gemfire/v1/nodes/0/locator-instances/3/logs/4/'))
