...
class TestGemFireCacheServerPendingConfiguration(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__configuration = GemFireCacheServerPendingConfiguration(self.__client,
    ...
    def test_attributes(self):
        ...
        self.assertEqual('groups-cache-server-instances-configurations-pending-content\n', self.__configuration.content)
