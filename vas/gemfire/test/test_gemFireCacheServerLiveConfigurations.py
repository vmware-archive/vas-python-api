...
class TestGemFireCacheServerLiveConfigurations(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__live_configurations = GemFireCacheServerLiveConfigurations(self.__client,
    ...
    def test__create_item(self):
        self.assertIsInstance(
            ...
            GemFireCacheServerLiveConfiguration)
