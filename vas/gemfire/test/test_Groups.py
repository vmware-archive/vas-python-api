...
from vas.gemfire.Groups import Groups, Group
...
class TestGroups(VasTestCase):
    def test_list(self):
        self._assert_collection(Groups(self._client, 'https://localhost:8443/gemfire/v1/groups/'))

    def test_create(self):
        node_0_location = 'https://localhost:8443/gemfire/v1/nodes/0/'
        node_1_location = 'https://localhost:8443/gemfire/v1/nodes/1/'
        location = 'https://localhost:8443/gemfire/v1/groups/'
        self._return_location('https://localhost:8443/gemfire/v1/groups/2/')
    ...
    def test_detail(self):
        self._assert_item(Group(self._client, 'https://localhost:8443/gemfire/v1/groups/2/'), [
            ('name', 'example-group'),
            ('agent_instances', lambda actual: self.assertIsInstance(actual, AgentInstances)),
            ('cache_server_instances', lambda actual: self.assertIsInstance(actual, CacheServerInstances)),
            ...
            ('nodes', [
                Node(self._client, 'https://localhost:8443/gemfire/v1/nodes/0/'),
                Node(self._client, 'https://localhost:8443/gemfire/v1/nodes/1/')
            ])
        ])
    ...
    def test_update(self):
        node_0_location = 'https://localhost:8443/gemfire/v1/nodes/0/'
        node_1_location = 'https://localhost:8443/gemfire/v1/nodes/1/'
        node_2_location = 'https://localhost:8443/gemfire/v1/nodes/2/'
        location = 'https://localhost:8443/gemfire/v1/groups/2/'
    ...
    def test_delete(self):
        self._assert_deletable(Group(self._client, 'https://localhost:8443/gemfire/v1/groups/2/'))
