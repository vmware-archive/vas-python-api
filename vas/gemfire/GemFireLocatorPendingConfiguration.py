...
from vas.shared.PendingConfiguration import PendingConfiguration

class GemFireLocatorPendingConfiguration(PendingConfiguration):
    """A GemFire locator pending configuration

    :ivar `vas.gemfire.GemFireLocatorGroupInstance` instance: The configuration's parent group instance
    ...
    def __init__(self, client, location):
        super(GemFireLocatorPendingConfiguration, self).__init__(client, location, self.__REL_GROUP_INSTANCE)
