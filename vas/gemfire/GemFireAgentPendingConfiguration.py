...
class GemFireAgentPendingConfiguration(PendingConfiguration):
    """A GemFire agent pending configuration

    :ivar `vas.gemfire.GemFireAgentGroupInstance` instance: The configuration's parent group instance
    ...
    def __init__(self, client, location):
        super(GemFireAgentPendingConfiguration, self).__init__(client, location, self.__REL_GROUP_INSTANCE)
