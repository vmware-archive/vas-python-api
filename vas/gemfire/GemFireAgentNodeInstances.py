...
class GemFireAgentNodeInstances(CollectionType):
    """A collection of GemFire agent node instances

    :ivar `vas.shared.Security` security:   The security configuration for the collection of node instances
    """

    __COLLECTION_KEY = 'agent-node-instances'

    def __init__(self, client, location):
        super(GemFireAgentNodeInstances, self).__init__(client, location, self.__COLLECTION_KEY)
