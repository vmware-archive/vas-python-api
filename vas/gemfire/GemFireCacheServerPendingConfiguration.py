...
class GemFireCacheServerPendingConfiguration(PendingConfiguration):
    """A GemFire cache server pending configuration
    ...
    def __init__(self, client, location):
        super(GemFireCacheServerPendingConfiguration, self).__init__(client, location, self.__REL_GROUP_INSTANCE)
