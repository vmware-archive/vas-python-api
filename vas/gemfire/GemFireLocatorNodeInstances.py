...
class GemFireLocatorNodeInstances(CollectionType):
    """A collection of GemFire locator node instances

    :ivar `vas.shared.Security` security:   The security configuration for the collection of node instances
    """

    __COLLECTION_KEY = 'locator-node-instances'

    def __init__(self, client, location):
        super(GemFireLocatorNodeInstances, self).__init__(client, location, self.__COLLECTION_KEY)
