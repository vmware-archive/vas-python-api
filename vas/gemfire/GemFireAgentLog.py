...
class GemFireAgentLog(Log):
    ...
    def __init__(self, client, location):
        super(GemFireAgentLog, self).__init__(client, location, self.__REL_NODE_INSTANCE)
