...
class GemFireLocatorLiveConfiguration(LiveConfiguration):
    """A GemFire locator live configuration
    ...
    def __init__(self, client, location):
        super(GemFireLocatorLiveConfiguration, self).__init__(client, location, self.__REL_GROUP_INSTANCE)
