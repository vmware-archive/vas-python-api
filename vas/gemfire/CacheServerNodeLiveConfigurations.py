...
class CacheServerNodeLiveConfigurations(Collection):
    ...
    def __init__(self, client, location):
        super(CacheServerNodeLiveConfigurations, self).__init__(client, location, 'node-live-configurations',
            CacheServerNodeLiveConfiguration)
...
class CacheServerNodeLiveConfiguration(NodeConfiguration):
    ...
    def __init__(self, client, location):
        super(CacheServerNodeLiveConfiguration, self).__init__(client, location, 'cache-server-node-instance',
            CacheServerNodeInstance, CacheServerLiveConfiguration)
