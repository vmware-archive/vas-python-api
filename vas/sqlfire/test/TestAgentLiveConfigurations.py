...
from vas.sqlfire.AgentLiveConfigurations import AgentLiveConfigurations, AgentLiveConfiguration
...
class TestAgentLiveConfigurations(VasTestCase):
    def test_list(self):
        self._assert_collection(AgentLiveConfigurations(self._client,
            'https://localhost:8443/sqlfire/v1/groups/0/agent-instances/1/configurations/live/'), 1)

    def test_detail(self):
        self._assert_item(AgentLiveConfiguration(self._client,
            'https://localhost:8443/sqlfire/v1/groups/0/agent-instances/1/configurations/live/2/'), [
            ...
            ('node_configurations', [
                AgentNodeLiveConfiguration(self._client,
                    'https://localhost:8443/sqlfire/v1/nodes/0/agent-instances/4/configurations/live/7/'),
                AgentNodeLiveConfiguration(self._client,
                    'https://localhost:8443/sqlfire/v1/nodes/0/agent-instances/3/configurations/live/6/')])
        ])
