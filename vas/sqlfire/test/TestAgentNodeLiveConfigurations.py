...
from vas.sqlfire.AgentNodeLiveConfigurations import AgentNodeLiveConfigurations, AgentNodeLiveConfiguration
...
class TestAgentNodeLiveConfigurations(VasTestCase):
    def test_list(self):
        self._assert_collection(AgentNodeLiveConfigurations(self._client,
            'https://localhost:8443/sqlfire/v1/nodes/2/agent-instances/3/configurations/live/'), 1)

    def test_detail(self):
        self._assert_item(AgentNodeLiveConfiguration(self._client,
            'https://localhost:8443/sqlfire/v1/nodes/0/agent-instances/3/configurations/live/5/'), [
