...
class NodeLiveConfiguration(NodeConfiguration):
    ...
    :ivar `vas.tc_server.LiveConfigurations.LiveConfiguration`  group_configuration:    The node configuration's group
                                                                                        configuration
    :ivar `vas.tc_server.NodeInstances.NodeInstance`            instance:               The instance the owns the
                                                                                        configuration
