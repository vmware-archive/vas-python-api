...
class TcServerInstallationImage(InstallationImage):
    """A tc Server installation image

    :ivar list installations: The :class:`vas.tc_server.TcServerInstallation` s that use the installation image
