...
class TcServerPendingConfigurations(PendingConfigurations):
    """An collection of tc Server pending configurations
    ...
    def _create_item(self, client, location):
        return TcServerPendingConfiguration(client, location)
