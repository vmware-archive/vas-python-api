...
class TestTcServerLiveConfigurations(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__live_configurations = TcServerLiveConfigurations(self.__client,
            'https://localhost:8443/tc-server/v1/groups/0/instances/1/configurations/live/')
