...
class TestTcServerNodeRevisions(TestCase):
    __client = StubClient()

    def setUp(self):
        self.__client.delegate.reset_mock()
        self.__revisions = TcServerNodeRevisions(self.__client,
    ...
    def test_repr(self):
        self.assertIsNone(re.match('<.* object at 0x.*>', repr(self.__revisions)), '__repr__ method has not been specified')
