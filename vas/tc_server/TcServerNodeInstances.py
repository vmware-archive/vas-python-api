...
class TcServerNodeInstances(CollectionType):
    """A collection of tc Server node instances

    :ivar `vas.shared.Security` security:   The security configuration for the collection of node instances
    """

    __COLLECTION_KEY = 'node-instances'

    def __init__(self, client, location):
        super(TcServerNodeInstances, self).__init__(client, location, self.__COLLECTION_KEY)
